<template>
  <section class="timer mt-24 mb-16">
    <div class="card">
      ...
      <div class="card-body py-10 px-8 flex gap-x-4 md:gap-x-8 items-center justify-center">
        ...
        <div class="flex flex-col gap-y-4 items-center">
          ...
          <p class="uppercase font-medium">Mins</p>
        </div>
      </div>
    </div>

    <p class="font-medium text-base mt-4">Team lock: {{ moment().day(7).startOf("day").format("Do MMM, hh:mm A") }}</p>
  </section>
</template>
